export const sendCategoriesTemplate = () => {
  return {
    attachment: {
      type: 'template',
      payload: {
...
export const sendHeadphonesTemplate = () => {
  return {
    attachment: {
      type: 'template',
      payload: {
...
export const sendLookupOrderTemplate = () => {
  return {
    attachment: {
      type: 'template',
      payload: {
...
export const backToMainMenuTemplate = () => {
  return {
...
export const setInfoOrderTemplate = () => {
  return {
    attachment: {
      type: 'template',
      payload: {
